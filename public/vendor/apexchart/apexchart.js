    ...
    var A, S, C = {
        ...
        return a(t, [{
            ...
            key: "drawPoint", value: function (t, e, i, a, s, r, n) {
                var o = this.w, l = s, h = new x(this.ctx), c = new p(this.ctx), d = new T(this.ctx),
                    g = new z(this.ctx), u = new b(this.ctx), f = g.getMarkerConfig("apexcharts-marker", l),
                    m = d.fillPath({
                        seriesNumber: s,
                        dataPointIndex: r,
            ...
            key: "drawDataLabel", value: function (t, e, i) {
                ...
                for (var g = 0; g < t.x.length; g++) if (l = t.x[g] + o.offsetX, h = t.y[g] + o.offsetY + s, !isNaN(l)) {
                    ...
                    if ("bubble" === r.config.chart.type) {
                        ...
                        var x = new I(this.ctx), m = x.centerTextInBubble(h, e, c);
                        h = m.y
                    } else void 0 !== u && (f = p(u));
        ...
        return a(t, [{
            ...
            key: "drawCalculatedDataLabels", value: function (t) {
                ...
                var u = new M(this.barCtx.ctx), f = new b(this.barCtx.ctx), p = c.formatter, x = null,
        ...
        return a(t, [{
            ...
            key: "getPathFillColor", value: function (t, e, i, a) {
                var s = this.w, r = new T(this.barCtx.ctx), n = null, o = this.barCtx.barOptions.distributed ? i : e;
            ...
            key: "barBackground", value: function (t) {
                var e = t.j, i = t.i, a = t.x1, s = t.x2, r = t.y1, n = t.y2, o = t.elSeries, l = this.w,
                    h = new b(this.barCtx.ctx), c = new X(this.barCtx.ctx).getActiveConfigSeriesIndex();
            ...
            key: "draw", value: function (t, e) {
                ...
                for (var s = a.group({class: "apexcharts-rangebar-series apexcharts-plot-series"}), r = 0; r < t.length; r++) {
                    ...
                    for (var y = a.group({
                        ...
                        d = C.y, c = C.x;
                        var I = this.barHelpers.getPathFillColor(t, r, w, u), M = i.globals.stroke.colors[u];
                        this.renderSeries({
                            realIndex: u,
                            pathFill: I,
                            lineFill: M,
                    ...
                    tooltip: {
                        shared: !1, followCursor: !0, custom: function (t) {
                            return t.w.config.plotOptions && t.w.config.plotOptions.bar && t.w.config.plotOptions.bar.horizontal ? function (t) {
                                var e = new R(t.ctx, null), i = e.getTooltipValues(t), a = i.color, s = i.seriesName,
        ...
        return a(i, [{
            key: "init", value: function (e) {
                var i = e.responsiveOverride, a = this.opts, s = new L, r = new H(a);
            ...
            key: "checkForCatToNumericXAxis", value: function (t, e, i) {
                var a = new H(i), s = "bar" === t && i.plotOptions && i.plotOptions.bar && i.plotOptions.bar.horizontal,
        ...
        return a(t, [{
            ...
            key: "isFormatXY", value: function () {
                var t = this.w.config.series.slice(), e = new X(this.ctx);
        ...
        return a(t, [{
            key: "getLabel", value: function (t, e, i, a) {
                var s = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : [],
                    ...
                    c = n.config.xaxis.labels.formatter, d = !1, g = new V(this.ctx), u = o;
        ...
        return a(t, [{
            ...
            key: "exportToCSV", value: function (t) {
                var e = this, i = t.series, a = t.columnDelimiter, s = t.lineDelimiter, r = void 0 === s ? "\n" : s,
                    n = this.w, o = [], l = [], h = "data:text/csv;charset=utf-8,", c = new B(this.ctx),
                    d = new G(this.ctx), g = function (t) {
                        var i = "";
                        if (n.globals.axisCharts) {
                            if ("category" === n.config.xaxis.type || n.config.xaxis.convertedCatToNumeric) if (n.globals.isBarHorizontal) {
                                var a = n.globals.yLabelFormatters[0], s = new X(e.ctx).getActiveConfigSeriesIndex();
        ...
        return a(t, [{
            ...
            key: "drawXaxisInversed", value: function (t) {
                var e, i, a = this.w, s = new b(this.ctx),
        ...
        return a(t, [{
            key: "drawYaxis", value: function (t) {
                var e = this.w, i = new b(this.ctx), a = e.config.yaxis[t].labels.style, s = a.fontSize,
                    r = a.fontFamily, n = a.fontWeight, o = i.group({
                ...
                o.add(l);
                var h = e.globals.yAxisScale[t].result.length - 1, c = e.globals.gridHeight / h,
                    d = e.globals.translateY, g = e.globals.yLabelFormatters[t],
                    u = e.globals.yAxisScale[t].result.slice();
                u = this.axesUtils.checkForReversedLabels(t, u);
                var f = "";
                if (e.config.yaxis[t].labels.show) for (var p = function (o) {
                    var p = u[o];
                    p = g(p, o);
                    ...
                    if (o === h && (f = b), l.add(b), 0 !== e.config.yaxis[t].labels.rotate) {
                        var m = i.rotateAroundCenter(f.node), v = i.rotateAroundCenter(b.node);
                ...
                var w = e.config.yaxis[t].axisBorder, k = 31 + w.offsetX;
        ...
        return a(t, [{
            ...
            key: "getTotalYAxisWidth", value: function () {
                var t = this.w, e = 0, i = 0, a = 0, s = t.globals.yAxisScale.length > 1 ? 10 : 0,
                    r = new G(this.dCtx.ctx), n = function (n, o) {
        ...
        return a(t, [{
            ...
            key: "drawLegends", value: function () {
                ...
                for (var r = t.globals.legendFormatter, n = t.config.legend.inverseOrder, o = n ? i.length - 1 : 0; n ? o >= 0 : o <= i.length - 1; n ? o-- : o++) {
                    ...
                    var f = t.config.legend.markers.offsetX, p = t.config.legend.markers.offsetY,
                        x = t.config.legend.markers.height, m = t.config.legend.markers.width,
                        v = t.config.legend.markers.strokeWidth, w = t.config.legend.markers.strokeColor,
                        k = t.config.legend.markers.radius, A = u.style;
            ...
            key: "setLegendWrapXY", value: function (t, e) {
                ...
                if ("bottom" === i.config.legend.position) n += i.globals.svgHeight - s.height / 2; else if ("top" === i.config.legend.position) {
                    var o = new lt(this.ctx), l = o.dimHelpers.getTitleSubtitleCoords("title").height,
            ...
            key: "zoomUpdateOptions", value: function (t, e) {
                ...
                if (void 0 !== t || void 0 !== e) {
                    if (!(i.config.xaxis.convertedCatToNumeric && (t < 1 && (t = 1, e = i.globals.dataPoints), e - t < 2))) {
                        ...
                        if (i.config.chart.zoom.autoScaleYaxis) n = new q(this.ctx).autoScaleY(this.ctx, n, {xaxis: a});
        ...
        return a(s, [{
            ...
            key: "panScrolled", value: function (t, e) {
                ...
                var r = {min: t, max: e};
                i.config.chart.zoom.autoScaleYaxis && (s = new q(this.ctx).autoScaleY(this.ctx, s, {xaxis: r}));
        ...
        return a(t, [{
            key: "drawSeriesTexts", value: function (t) {
                var e = t.shared, i = void 0 === e || e, a = t.ttItems, s = t.i, r = void 0 === s ? 0 : s, n = t.j,
                    o = void 0 === n ? null : n, l = t.y1, h = t.y2, c = this.w;
        ...
        return a(t, [{
            key: "drawDynamicPoints", value: function () {
                var t = this.w, e = new b(this.ctx), i = new z(this.ctx),
        ...
        return a(s, [{
            key: "draw", value: function (t, e) {
                var i = this.w, a = new b(this.ctx), s = new T(this.ctx);
                ...
                for (var n = a.group({class: "apexcharts-candlestick-series apexcharts-plot-series"}), o = 0; o < t.length; o++) {
                    ...
                    for (var k = a.group({
                        ...
                        var P = s.fillPath({seriesNumber: p, dataPointIndex: A, color: S, value: t[o][A]}),
        ...
        return a(t, [{
            key: "draw", value: function (t) {
                ...
                for (var h = o ? 0 : l.length - 1; o ? h < l.length : h >= 0; o ? h++ : h--) {
                    ...
                    for (var g = 0, u = 0; u < l[h].length; u++) {
                        var x = 1, m = e.config.plotOptions.heatmap.shadeIntensity, v = this.determineHeatColor(h, u);
                        ...
                        var k = this.rectRadius, A = i.drawRect(g, n, s, r, k);
                        if (A.attr({
                            cx: g,
                            cy: n
            ...
            key: "determineHeatColor", value: function (t, e) {
                var i = this.w, a = i.globals.series[t][e], s = i.config.plotOptions.heatmap,
                    r = s.colorScale.inverse ? e : t, n = i.globals.colors[r], o = null,
                    l = Math.min.apply(Math, g(i.globals.series[t])), h = Math.max.apply(Math, g(i.globals.series[t]));
                ...
                var c = Math.abs(h) + Math.abs(l), d = 100 * a / (0 === c ? c - 1e-6 : c);
            ...
            key: "calculateHeatmapDataLabels", value: function (t) {
                var e = t.x, i = t.y, a = t.i, s = t.j, r = t.heatColorProps, n = (t.series, t.rectHeight),
                    o = t.rectWidth, l = this.w, h = l.config.dataLabels, c = new b(this.ctx), d = new M(this.ctx),
                    g = h.formatter, u = null;
                if (h.enabled) {
                    u = c.group({class: "apexcharts-data-labels"});
                    var f = h.offsetX, p = h.offsetY, x = e + o / 2 + f,
        ...
        return a(t, [{
            ...
            key: "drawArcs", value: function (t, e) {
                var i = this.w, a = new p(this.ctx), s = new b(this.ctx), r = new T(this.ctx),
                ...
                for (var g = 0; g < t.length; g++) {
                    ...
                    if (!this.initialAnim || i.globals.resized || i.globals.dataChanged ? this.animBeginArr.push(0) : (0 === (A = x / this.fullAngle * i.config.chart.animations.speed) && (A = 1), this.animDur = A + this.animDur, this.animBeginArr.push(this.animDur)), this.dynamicAnim && i.globals.dataChanged ? this.animatePaths(y, {
                        ...
                        if (0 !== x && i.config.plotOptions.pie.dataLabels.minAngleToShowLabel < t[g]) {
                            ...
                            void 0 !== P && (L = P(i.globals.seriesPercent[g][0], {seriesIndex: g, w: i}));
            ...
            key: "drawPolarElements", value: function () {
                var t = this.w, e = new q(this.ctx), i = new b(this.ctx), a = new At(this.ctx), s = i.group(),
        ...
        return a(t, [{
            key: "draw", value: function (t) {
                var e = this, i = this.w, a = new T(this.ctx), s = [], r = new M(this.ctx);
            ...
            key: "drawXAxisTexts", value: function () {
                ...
                return e.globals.labels.forEach((function (r, o) {
                    var l = e.config.xaxis.labels.formatter, h = new M(t.ctx);
                    if (s[o]) {
        ...
        return a(s, [{
            ...
            key: "drawTracks", value: function (t) {
                var e = this.w, i = new b(this.ctx), a = i.group({class: "apexcharts-tracks"}), s = new p(this.ctx),
                    r = new T(this.ctx), n = this.getStrokeWidth(t);
                t.size = t.size - n / 2;
            ...
            key: "drawArcs", value: function (t) {
                var e = this.w, i = new b(this.ctx), a = new T(this.ctx), s = new p(this.ctx), r = i.group(),
            ...
            key: "drawHollowImage", value: function (t, e, i, a) {
                var s = this.w, r = new T(this.ctx), n = f.randomId(), o = s.config.plotOptions.radialBar.hollow.image;
        ...
        return a(t, [{
            ...
            key: "generateYearScale", value: function (t) {
                var e = t.firstVal, i = t.currentMonth, a = t.currentYear, s = t.daysWidthOnXAxis, r = t.numberOfYears,
                    n = e.minYear, o = 0, l = new D(this.ctx);
            ...
            key: "generateMonthScale", value: function (t) {
                var e = t.firstVal, i = t.currentMonthDate, a = t.currentMonth, s = t.currentYear,
                    r = t.daysWidthOnXAxis, n = t.numberOfMonths, o = a, l = 0, h = new D(this.ctx), c = "month", d = 0;
                if (e.minDate > 1) {
            ...
            key: "generateDayScale", value: function (t) {
                var e = t.firstVal, i = t.currentMonth, a = t.currentYear, s = t.hoursWidthOnXAxis, r = t.numberOfDays,
                    n = new D(this.ctx), o = "day", l = e.minDate + 1, h = l, c = function (t, e, i) {
            ...
            key: "generateHourScale", value: function (t) {
                var e = t.firstVal, i = t.currentDate, a = t.currentMonth, s = t.currentYear, r = t.minutesWidthOnXAxis,
                    n = t.numberOfHours, o = new D(this.ctx), l = "hour", h = function (t, e) {
        ...
        return a(t, [{
            ...
            key: "plotChartType", value: function (t, e) {
                ...
                var d = new Tt(this.ctx, e), g = new wt(this.ctx, e);
                this.ctx.pie = new St(this.ctx);
                var u = new Lt(this.ctx), f = new R(this.ctx, e), p = new Ct(this.ctx), x = [];
                if (s.comboCharts) {
        ...
        return a(i, [{
            ...
            key: "_updateSeries", value: function (t, e) {
                ...
                }))).length && (i = [{data: []}]), r.config.series = i) : r.config.series = t.slice(), s && (r.globals.initialSeries = f.clone(r.config.series)), this.ctx.update({series: t})
            }
        }, {
    ...
    var Et = function () {
        ...
        return a(t, [{
            ...
            key: "clearDomElements", value: function () {
                var t = this, e = this.w.globals.dom.Paper.node;
    ...
    return function () {
        ...
        return a(t, [{
            ...
            key: "create", value: function (t, e) {
                ...
                var o = this.core.plotChartType(t, n), l = new M(this);
            ...
            key: "appendData", value: function (t) {
                ...
                return i.w.config.series = a, e && (i.w.globals.initialSeries = f.clone(i.w.config.series)), this.update({series: this.w.config.series})
            }
        }, {
            ...
            key: "_windowResize", value: function () {
                ...
                clearTimeout(this.w.globals.resizeTimer), this.w.globals.resizeTimer = window.setTimeout((function () {
                    t.w.globals.resized = !0, t.w.globals.dataChanged = !1, t.ctx.update({series: t.w.config.series})
                }), 150)
            }
        }], [{
