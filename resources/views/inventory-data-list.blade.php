                    ...
                    <div class="breadcrumbs" xmlns:v="http://rdf.data-vocabulary.org/#">
                        ...
                        <span typeof="v:Breadcrumb">
                            <a class="active" href="https://microdata.fao.org/index.php/catalog" rel="v:url"
                               property="v:title">Inventory Datasets</a>
                ...
                <form method="get" id="catalog-search-form">
                    ...
                    <div class="nada-search-box wb-controls-wrapper">
                        <div class="row mb-5 justify-content-center align-items-center">
                            <h1 class="wb-library-search-title  pb-3">Inventory Datasets</h1>
                                        ...
                                        <div class="survey-row border-bottom pb-3 mb-2 "
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="sub-title">
                                                        <div>
                                                            <span class="study-by">{{ $data->organization }}</span>
                                                        </div>

                                                        <span class="owner-collection collection-link mr-3">Collection:
                                                        <a
                                                            href="https://microdata.fao.org/index.php/catalog/Food-Security"><span class="badge badge-light">{{ $data->collection }}</span></a> </span>
                                                    </div>
                                                    <div class="survey-stats">
                                                    <span class="study-idno"><span class="text-dark-doi wb-value">{{ $data->data_access }}</span>
                                                    </span>
                                                    ...
                                                    <div class="wb-license-classification">Source
                                                    <span class="badge wb-data-access wb-badge btn-data-license-remote"
                                                          title="Microdata available from external repository">
                                                        <i class="icon-da-sm icon-da-remote"></i> <span class="">{{ $data->inventory_source }}</span>
                                                    </span>
